 ...
 */
export class MenuFilterGenreItemComponent extends mio.StatelessComponent<{genre: mio.GenreType, menu: mio.IMenuState}> {
  /**
   * Renders the component.
   */
  public render(): JSX.Element {
    let status = mio.option(this.props.menu.genres[this.props.genre]);
